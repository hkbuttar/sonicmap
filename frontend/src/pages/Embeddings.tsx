...
export function Embeddings() {
  ...
  return <><PageHeader eyebrow="Learned representations" title="Explore the learned spaces">Toggle between a genre-trained representation and an embedding optimized directly with triplet loss.</PageHeader>
