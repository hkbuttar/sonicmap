...
export function Playlists(){
  ...
  return <><PageHeader eyebrow="Playlist generation" title="A playlist that drifts without losing the thread">Walk locally through an embedding while moving gradually farther from the seed. Compare the two learned spaces.</PageHeader>
    ...
    <Card className="disclosure"><strong>No audio is hosted.</strong><p>This first deployment demonstrates model behavior with track identifiers and similarity values. Listening-based review remains a separate, explicitly human process.</p></Card>
  </>
}
