...
export function Generalization(){
  ...
  return <><PageHeader eyebrow="Cross-dataset generalization" title="The distribution shift was not subtle">Models trained on GTZAN met 2,999 unseen FMA tracks from the three defensible exact-overlap genres.</PageHeader>
