...
export function Similarity() {
  ...
  return <><PageHeader eyebrow="Similarity evaluation" title="Ask the catalog what sounds close">Compare the same seed across learned embeddings, engineered audio descriptors, and the label-only oracle baseline.</PageHeader>
