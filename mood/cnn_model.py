"""Small two-output CNN for continuous valence-arousal prediction."""
...
class MoodCNN(nn.Module):
    def __init__(self):
        ...
        self.head = nn.Sequential(nn.Flatten(), nn.Linear(64 * 4 * 4, 128), nn.ReLU(), nn.Dropout(0.3), nn.Linear(128, 2))
